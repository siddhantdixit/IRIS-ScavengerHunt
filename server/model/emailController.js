...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'dixit.siddhant123@gmail.com',
    pass: process.env.EMAILPASSWORD
  }
});

let mailOptions = {
  from: 'Siddhant Dixit <dixit.siddhant123@gmail.com>',
...
{
    let bodycontent = `Hi ${username}, Please verify your IRIS ScavengerHunt Account <br> <br>`;
