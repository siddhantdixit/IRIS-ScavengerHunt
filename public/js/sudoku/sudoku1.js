var words = [
    ...
    {number:15,direction:'across',row:13,column:12,clue:'there are many creators of python as its opensource but there is only one benevolent dictator',answer:'aaguidovonrossum',hint:'https://www.angelo.edu/asu_facts/traditions.php'},
...
var gridSize = [40,27];     // number of squares wide, number of squares tall
...
var $crosswordPuzzle = $('<div class="crossword-puzzle col-md-8 col-lg-9" style="float:left;margin-top:100px"></div>');
