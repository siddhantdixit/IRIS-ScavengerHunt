...
var gridSize = [40,35];     // number of squares wide, number of squares tall
...
var $crosswordPuzzle = $('<div class="crossword-puzzle col-md-8 col-lg-9" style="float:left;margin-top:70px";></div>');
...
// $('input[id*=\''+'d'+'-'+'10'+'-'+'1'+'\'').val('A');
// $('input[id*=\''+'d'+'-'+'10'+'-'+'2'+'\'').val('A');
// $('input[id*=\''+'d'+'-'+'10'+'-'+'3'+'\'').val('A');
// $('input[id*=\''+'d'+'-'+'10'+'-'+'4'+'\'').val('A');


let alleles = $('input.letter');
// console.log(alleles);
